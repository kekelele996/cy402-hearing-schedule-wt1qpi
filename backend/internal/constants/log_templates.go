...
const (
	...
	LogHearingCreateSuccess     = "hearing schedule success"
	LogHearingCreateFailed      = "hearing schedule failed"
	LogHearingConflictReject    = "hearing schedule rejected: lawyer interval conflict"
	LogHearingRescheduleStart   = "hearing reschedule start"
	LogHearingRescheduleSuccess = "hearing reschedule success"
	LogHearingRescheduleFailed  = "hearing reschedule failed"
	LogHearingCaseClosedReject  = "hearing schedule rejected: case closed or archived"
